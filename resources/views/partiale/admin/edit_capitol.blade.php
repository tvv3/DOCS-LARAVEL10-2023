...
@section('content')
<p class="d-block m-5">
  <a href="/show_capitole/{{$capitol->curs->id}}" class="nav-link nav-link-underlined">Inapoi la capitole</a>
</p>
<br><br>
...
<form class="myform" action="{{route('update_capitol',$capitol->id)}}" method="post">
    @csrf
    @method('PUT')
...
<div class="row  mb-3">
      ...
      <div class="col-sm-10">
      <input type="hidden" name="curs_id" id="curs_id" value="{{$capitol->curs->id}}">
      <input type="text" class="form-control" readonly="true"  name="curs" id="curs" value="{{$capitol->curs->curs}}">
      </div>
</div>
...
<div class="row  mb-3">
      ...
      <div class="col-sm-10">
        ...
        value="{{old('capitol')??$capitol->capitol}}">
       </div>
</div>
